---
title: Types
description: Canonical type reference for the Support component and related hooks, events, and shared data models.
search:
  kind: type
  tags:
    - types
...
This page is the canonical reference for shared Support component types. Other
support docs link here when a table row references a named type like
`TimelineItem`, `Conversation`, or `PublicVisitor`.
