---
title: Overview
description: Understand the storage and email responsibilities a self-hosted Cossistant deployment needs, and choose the setup path that fits your stack.
---
